...
import softwareArchi from '../assets/software_archi.png';
            ...
            {advisoryBoard.map((member, idx) => (
              <div className="advisory-card" key={idx}>
                <div className="advisory-card-left">
                  <div className={`advisory-avatar ${member.name === 'Varun KM' ? 'varun-avatar' : ''} ${member.name === 'Srinivasa R Rajagopal' ? 'srinivasa-avatar' : ''}`}>
                    <img src={member.avatar} alt={member.name} />
                  </div>
                  <h3>{member.name}</h3>
